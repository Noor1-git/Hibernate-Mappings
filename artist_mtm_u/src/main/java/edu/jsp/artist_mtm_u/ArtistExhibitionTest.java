...
public class ArtistExhibitionTest {
	...
	EntityManagerFactory emf = Persistence.createEntityManagerFactory("artist-exhibition");
	...
	public static void main(String[] args) {
		...
		test.insertArtistExhibitions(artist1, artist2, exhibition1, exhibition2);
	...
	public void insertArtistExhibitions(Artist artist1, Artist artist2, Exhibition exhibition1,
			Exhibition exhibition2) {
		artist1.getExhibitions().add(exhibition1);
		artist2.getExhibitions().add(exhibition2);
