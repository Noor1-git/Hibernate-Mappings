...
public class StudentSubjectTest {
	...
	EntityManagerFactory emf = Persistence.createEntityManagerFactory("student-subject");
	...
	public static void main(String[] args) {
		...
		test.insertStudentSubjects(student1, student2, mathSubject, scienceSubject);

		// Uncomment and call other methods for different operations
//        test.displayStudentSubjects(student1.getId());
...
//        test.removeStudentWithSubjects(student1.getId());
	...
	public void insertStudentSubjects(Student student1, Student student2, Subject subject1, Subject subject2) {
