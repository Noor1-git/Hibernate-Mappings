...
//        Product laptopProduct = new Product("Laptop", 1200.0,electronics);
        ...
        list.add(tShirtProduct);
        test.insertProductCategories(list,tShirtProduct,  clothing);
...
//        test.removeProduct(tShirtProduct.getId());
	...
	public void insertProductCategories(List<Product> list, Product product1, Category category1) {
