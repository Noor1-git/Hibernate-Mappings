...
public class UniversityTest {
    ...
    public static void main(String[] args) {
       ...
       test.insertUniversity(university, colleges,college,college1);
        
//        test.displayUniversity(1);
//        test.displayUniversity(1);
    }

    public void insertUniversity(University university, List<College> colleges,College...colleges2) {
        university.setColleges(colleges);
        
        for (College college : colleges2) {
